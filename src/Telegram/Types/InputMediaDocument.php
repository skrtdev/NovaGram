...
class InputMediaDocument extends Type{
    ...
    protected string $_ = 'InputMediaDocument';
    ...
    public function __construct(array $array, Bot $Bot = null){
        ...
        $this->thumb = isset($array['thumb']) ? new InputFile($array['thumb'], $Bot) : null;
        ...
        $this->disable_content_type_detection = $array['disable_content_type_detection'] ?? null;
